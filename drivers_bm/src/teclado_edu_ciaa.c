...
{
	teclado[Tec1] = Chip_GPIO_ReadPortBit(LPC_GPIO_PORT, TECLA_1_GPIO_NUMBER, TECLA_1_GPIO_PIN);
	teclado[Tec2] = Chip_GPIO_ReadPortBit(LPC_GPIO_PORT, TECLA_2_GPIO_NUMBER, TECLA_2_GPIO_PIN);
	teclado[Tec3] = Chip_GPIO_ReadPortBit(LPC_GPIO_PORT, TECLA_3_GPIO_NUMBER, TECLA_3_GPIO_PIN);
	teclado[Tec4] = Chip_GPIO_ReadPortBit(LPC_GPIO_PORT, TECLA_4_GPIO_NUMBER, TECLA_4_GPIO_PIN);
}
